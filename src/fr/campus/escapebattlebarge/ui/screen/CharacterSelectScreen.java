...
/*
 * Cette classe affiche l'écran de sélection de classe et de saisie du nom.
    ...
    public void show(Consumer<String> onMarineSelected, Consumer<String> onLibrarianSelected) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            Runnable validate = () -> {
                ...
                // Ici on bloque tant que le nom est vide.
                if (v.isEmpty()) {
                    Toolkit.getDefaultToolkit().beep();
                    return;
                }
            ...
            // Raccourcis clavier pour jouer vite sans souris.
